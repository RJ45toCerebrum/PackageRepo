...
<root>
  ...
  ├── Editor
  │   ├── Nullterminated.Testtool.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Nullterminated.Testtool.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Nullterminated.Testtool.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Nullterminated.Testtool.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Nullterminated.Testtool`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package TestTool Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Nullterminated.Testtool.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Nullterminated.Testtool.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Nullterminated.Testtool.Editor.Tests.asmdef`

  `Tests/Runtime/Nullterminated.Testtool.Tests.asmdef`
...
Use the `Documentations~/TestTool.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
